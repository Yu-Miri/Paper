MOSTEL : Qu, Yadong, et al. "Exploring Stroke-Level Modifications for Scene Text Editing." arXiv preprint arXiv:2212.01982 (2022).
...
Guide masking image를 참고하여 Text 영역과 Background 영역을 분리하여 Inpaint 수행

내일 웹사이트 배경화면 바꿔야함

Future work 더 추가

inference 사진 교체 p.43, 44 

29, 45p 멘트 수정하고 배경 회색으로 넣어주고 버튼모양으로 바꾸기

32p 글자 정렬

30p 한 번에 Inpaint & Transfer를 진행하는 SRNet과 달리 Mostel Method를 적용시켜 높은 퀄리티로 Transfer 성능 개선
